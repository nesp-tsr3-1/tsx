...
To open R studio and open an example script for generating the TSX output:
----
(cd r; rstudio lpi.R)
----

After a short delay, R studio should appear.

//image::vm-rstudio.png[R studio screenshot - start up, 600]

Press `Shift + Ctrl + S` to run the LPI and generate the TSX.

//image::vm-rstudio-plot.png[R studio screenshot, 600]
